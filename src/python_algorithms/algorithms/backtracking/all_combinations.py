...
class BacktrackingAllCombinations(object):
    ...
    def generate_all_combinations(self, n: int, k: int) -> list[list[int]]:
        """
        ...
        self.create_all_state(1, n, k, [], result)
        return result
    ...
    def create_all_state(
        ...
        for i in range(increment, total_number - level + 2):
            ...
            self.create_all_state(i + 1, total_number, level - 1, current_list, total_list)
            current_list.pop()
