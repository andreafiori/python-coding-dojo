...
class BST():
    ...
    def DFS_Inorder(self):
        return BSTHelper().inorder_traversal(self.root, [])

    def DFS_Preorder(self):
        return BSTHelper().preorder_traversal(self.root, [])

    def DFS_Postorder(self):
        return BSTHelper().postorder_traversal(self, self.root, [])


class BSTHelper:
    def inorder_traversal(self, node, DFS_list):
        if node.left:
            BSTHelper.inorder_traversal(self, node.left, DFS_list)
        DFS_list.append(node.data)
        if node.right:
            BSTHelper.inorder_traversal(self, node.right, DFS_list)
        return DFS_list


    def preorder_traversal(self, node,DFS_list):
        DFS_list.append(node.data)
        if node.left:
            BSTHelper.preorder_traversal(self, node.left, DFS_list)
        if node.right:
            BSTHelper.preorder_traversal(self, node.right, DFS_list)
        return DFS_list


    def postorder_traversal(self, node, DFS_list):
        if node.left:
            BSTHelper.postorder_traversal(self, node.left, DFS_list)
        if node.right:
            BSTHelper.postorder_traversal(self, node.right, DFS_list)
        DFS_list.append(node.data)
        return DFS_list
